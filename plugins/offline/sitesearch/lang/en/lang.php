<?php return [
    ...
    'settings'          => [
        ...
        'product_posturl'               => 'Url of product post page',
        'product_posturl_comment'       => 'Only specify the fixed part of the URL without any dynamic parameters',
        'product_page'                  => 'Product post page',
        'product_page_comment'          => 'Select a page used to display a single product post. Needed to form URL for posts.',
