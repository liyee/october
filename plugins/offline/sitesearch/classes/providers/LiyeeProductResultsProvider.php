 ...
 * Liyee.Product plugin
 *
 * @package OFFLINE\SiteSearch\Classes\Providers
 */
class LiyeeProductResultsProvider extends ResultsProvider
{
    /**
    ...
    public function search()
    {
        ...
        foreach ($this->posts() as $post) {
            ...
            if (Settings::get('liyee_product_page') !== null) {
                $result->url = $post->setUrl(Settings::get('liyee_product_page', ''), $this->controller);
            } else {
    ...
    {
        // If Liyee.Translate is not installed or we are currently,
        ...
        // If Liyee.Translate is available we also have to
        // query the liyee_translate_attributes table for translated
    ...
    protected function postsFromCurrentLocale()
    {
        ...
        $results = DB::table('liyee_translate_attributes')
    ...
    /**
     * Checks if the Liyee.Product Plugin is installed and
    ...
    protected function isInstalledAndEnabled()
    {
        return $this->isPluginAvailable($this->identifier)
            && Settings::get('liyee_product_enabled', true);
    }

    /**
     * Generates the url to a product post.
     *
     * @param $post
     *
     * @return string
    ...
    {
        $url = trim(Settings::get('liyee_product_posturl', '/product/post'), '/');
    ...
    {
        return Settings::get('liyee_product_label', 'Product');
    }
