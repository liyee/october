...
return [
    ...
    'product' => [
        'menu_label' => 'Product',
        'menu_description' => 'Manage Product Posts',
        'posts' => 'Posts',
        'create_post' => 'Product post',
        'categories' => 'Categories',
        'create_category' => 'Product category',
        'tab' => 'Product',
        'access_posts' => 'Manage the product posts',
        'access_categories' => 'Manage the product categories',
        'access_other_posts' => 'Manage other users product posts',
        'access_import_export' => 'Allowed to import and export posts',
        'access_publish' => 'Allowed to publish posts',
        'manage_settings' => 'Manage product settings',
    ...
    'post' => [
        ...
        'categories_comment' => 'Select categories the product post belongs to',
    ...
    'menuitem' => [
        ...
        'all_product_posts' => 'All product posts',
        'category_product_posts' => 'Product category posts'
    ],
    'settings' => [
        'category_title' => 'Category List',
        'category_description' => 'Displays a list of product categories on the page.',
        'category_slug' => 'Category slug',
        'category_slug_description' => "Look up the product category using the supplied slug value. This property is used by the default component partial for marking the currently active category.",
        ...
        'post_title' => 'Post',
        'post_description' => 'Displays a product post on the page.',
        'post_slug' => 'Post slug',
        'post_slug_description' => "Look up the product post using the supplied slug value.",
        ...
        'posts_description' => 'Displays a list of latest product posts on the page.',
        ...
        'posts_no_posts_description' => 'Message to display in the product post list in case if there are no posts. This property is used by the default component partial.',
        ...
        'posts_post_description' => 'Name of the product post page file for the "Learn more" links. This property is used by the default component partial.',
        ...
        'rssfeed_product' => 'Product page',
        'rssfeed_product_description' => 'Name of the main product page file for generating links. This property is used by the default component partial.',
